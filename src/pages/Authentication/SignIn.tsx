...
const SignIn: React.FC<SignInProps> = ({ setIsAuthenticated }) => {
    ...
    try {
      ...
      if (error.response) {
        if (error.response.status === 401) {
          ...
          setMessage(`Sign in failed: ${error.response.data.message || 'An error occurred'}`);
        }
      } else {
  ...
  return (
    <>
      ...
      <div className="rounded-sm py-12 border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
